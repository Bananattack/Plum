do local Self = {}
    ...
    function Self:update()
        ...
        if self.x < world.x then
            self.x = world.x
        elseif self.x > world.x + plum.screen.width - self.frame.width then
            self.x = world.x + plum.screen.width - self.frame.width
        end
    ...
    function Self:render()
        plum.screen:solidCircle(self.x - world.x + self.frame.width / 2, 180, 20, 3, plum.color.Black)
