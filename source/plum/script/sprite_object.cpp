    ...
    namespace script
    {
        ...
        void initSpriteObject(lua_State* L)
        {
            ...
            const luaL_Reg functions[] = {
                {"__gc", [](lua_State* L)
                {
                    return script::wrapped<Sprite>(L, 1)->gc(L);
                }},
                {"__index", [](lua_State* L)
                {
                    return script::wrapped<Sprite>(L, 1)->index(L);
                }},
                {"__newindex", [](lua_State* L)
                {
                    return script::wrapped<Sprite>(L, 1)->newindex(L);
                }},
                {"__tostring", [](lua_State* L)
                {
                    return script::wrapped<Sprite>(L, 1)->tostring(L);
                }},
                {"clear", [](lua_State* L)
                {
