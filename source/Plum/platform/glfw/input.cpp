        ...
        public:
            ...
            void handle(const Event& event)
            {
                switch(event.type)
                {
                    ...
                    {
                        bool pressed = event.mouse.button.action == GLFW_PRESS;
                        switch(event.mouse.button.button)
                        {
                            case GLFW_MOUSE_BUTTON_LEFT: l.setPressed(pressed); break;
                            case GLFW_MOUSE_BUTTON_MIDDLE: m.setPressed(pressed); break;
                            case GLFW_MOUSE_BUTTON_RIGHT: r.setPressed(pressed); break;
                            default: break;
                        }
                        break;
                    }
                    ...
                    case EventMouseScroll:
                        wu.setPressed(event.mouse.scroll.dy < 0);
                        wd.setPressed(event.mouse.scroll.dy > 0);
                        break;
                    default: break;
                }
            }
