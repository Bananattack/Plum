...
namespace Plum
{
	static Script::ImageWrapper* checkValidImageObject(lua_State* L, int index)
	{
		return (Script::ImageWrapper*) luaL_checkudata(L, index, "plum_image");
	}
	...
	{
		Script::ImageWrapper* img = checkValidImageObject(L, 1);
	...
	SCRIPT_OBJ_GETTER(imageGetField, Script::ImageWrapper*, "plum_image")
	SCRIPT_OBJ_SETTER(imageSetField, Script::ImageWrapper*, "plum_image")
	...
	static int imageBlit(lua_State* L)
	{
		...
		Script::ImageWrapper* dest = checkValidImageObject(L, 4);
	...
	void Script::initImageClass(lua_State* L)
	{
